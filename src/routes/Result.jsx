  ...
  return (
    <>
      <div className="mb-7 flex items-center">
        <div className="grow">
          <h1 className="mb-2 text-3xl font-bold capitalize">{word}</h1>
          <span className="font-sans text-lg text-accent">{"/ˈkiːbɔːd/"}</span>
        </div>
        <button className="h-12 w-12 shrink-0 rounded-full">
          <svg
            className="h-12 w-12"
      ...
      <section className="mb-7">
        <h2 className="mb-7 flex items-center gap-4 text-lg font-bold italic after:inline-block after:h-px after:w-full after:bg-secondary-300 after:transition-colors after:duration-300 after:content-[''] dark:after:bg-primary-300">
          noun
        </h2>

        <article className="mb-6">
          <h3 className="mb-4 text-secondary-400">Meaning</h3>
        ...
        <article className="mb-6 flex gap-6">
          <h3 className="mb-4 text-secondary-400">Synonyms</h3>
      ...
      <footer className="border-t border-secondary-300 pt-6 transition-colors duration-300 dark:border-primary-300">
        <p className="mb-3 text-secondary-400">Source</p>
